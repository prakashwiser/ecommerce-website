                ...
                <Col md={7}>
                  ...
                  {item.listingType == "sketeboard" && (
                    <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                      ...
                      <li>
                        Bearings & Wheels: It has high-precision ball bearings
                        and its wheels are made up of PVC material. Wheel
                        hardness is 61mm that will give you smooth and
                        comfortable rides.
                      </li>
                      <li>
                        Attractive designs: This skateboard has different and
                        attractive graphics that will attract you to take a
                        ride. You can also show off to your family and friends
                        its unique graphics.
                      </li>
                      <li>
                        Weight Handling Capacity: It can handle weight upto
                        75kg. So people of all age can ride this skateboard.
                      </li>
                    </ul>
                  )}
                  {item.listingType == "clothing" && (
                    <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                      ...
                      <li>
                        Occasion:- Night Wear, Beach Wear, Summer Wear,
                        Hangouts, Picnic, Vacation Wear. Great sleep short set,
                        men's pajama shorts set, men's loungewear, men's short
                        pajama set.
                      </li>
                      <li>
                        Size:- Select as per your body requirement, To ensure
                        that our garments fit you well, it is essential that you
                  ...
                  {item.listingType == "shoe" && (
                    <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                      ...
                      <li>
                        Comfort Sole & Flexible Walk : The outsoles are made by
                        an air cushion, doubling the effect of shock absorption.
                  ...
                  {item.listingType == "headphone" && (
                    <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                      <li>
                        ...
                        exceptional all-day comfort and greater stability. With
                        a refined contour, shorter stem and quick-press controls
                        for music or calls. PERSONALISED SPATIAL AUDIO —
                        Personalised Spatial Audio with dynamic head tracking
                        places sound all around you, creating a theatre-like
                        listening experience for music, TV shows, movies, games
                        and more.
                      </li>
                      <li>
                        IMPROVED SOUND AND CALL QUALITY — AirPods 4 feature the
                        Apple-designed H2 chip. Voice Isolation improves the
                        quality of phone calls in loud conditions. Using
                        advanced computational audio, it reduces background
                        noise while isolating and clarifying the sound of your
                        voice for whoever you’re speaking to.
                      </li>
                      <li>
                        LONG BATTERY LIFE — Get up to 5 hours of listening time
                        on a single charge. And get up to 30 hours of total
                        listening time using the case. REDESIGNED CASE — The
                        Charging Case comes with USB-C charging capabilities and
                        is more than 10% smaller by volume than the previous
                        generation.*
                      </li>
                    </ul>
                  )}
                  {item.listingType == "mobile" && (
                    <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                      <li>
                        ...
                        Dynamic Island transitions, and Voice Isolation for
                        phone calls. And A16 Bionic is incredibly efficient to
                        help deliver great all-day battery life.
                      </li>
                      <li>
                        NEXT-GENERATION PORTRAITS — Capture portraits with
                        dramatically more detail and color. Just tap to shift
                        the focus between subjects — even after you take the
                        shot.
                      </li>
                      <li>
                        POWERHOUSE A16 BIONIC CHIP — The superfast chip powers
                  ...
                  <Offcanvas show={cart} onHide={() => setCart(false)}>
                    <Offcanvas.Header closeButton>
                      <Offcanvas.Title>Order Produts</Offcanvas.Title>
                    </Offcanvas.Header>
                    <Offcanvas.Body className="d-flex flex-column gap-3">
                      <Button variant="success">{item.name}</Button>
                      <Button variant="success">{item.price}</Button>
                      <Button variant="success">{item.listingType}</Button>
                      <Link className="bg-warning w-25 text-center text-white rounded-pill" href="#">Buy Now</Link>
                    </Offcanvas.Body>
                  </Offcanvas>
                </Col>
              </React.Fragment>
